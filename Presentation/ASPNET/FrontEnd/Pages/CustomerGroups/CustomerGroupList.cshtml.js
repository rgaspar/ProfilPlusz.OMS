const App = {
    setup() {
        ...
        const services = {
            getMainData: () => AxiosManager.get('/CustomerGroup/GetCustomerGroupList', {}),
            createMainData: (name, description, createdById) =>
                AxiosManager.post('/CustomerGroup/CreateCustomerGroup', { name, description, createdById }),
            updateMainData: (id, name, description, updatedById) =>
                AxiosManager.post('/CustomerGroup/UpdateCustomerGroup', { id, name, description, updatedById }),
            deleteMainData: (id, deletedById) =>
                AxiosManager.post('/CustomerGroup/DeleteCustomerGroup', { id, deletedById }),
        };
